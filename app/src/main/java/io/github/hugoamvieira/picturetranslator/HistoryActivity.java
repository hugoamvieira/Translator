...
public class HistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] dbCols = {
                ...
                DBContract.Translation.COLUMN_LABEL_NAME,
                DBContract.Translation.COLUMN_LABEL_CONFIDENCE,
        ...
        for (cursor.moveToFirst(); !cursor.isAfterLast(); cursor.moveToNext()) {
            ...
            String labelName = cursor.getString(cursor.getColumnIndex(DBContract.Translation.COLUMN_LABEL_NAME));
            String labelConfidence = cursor.getString(cursor.getColumnIndex(DBContract.Translation.COLUMN_LABEL_CONFIDENCE));
            ...
            tv.setTextSize(18);
            tv.setText("Label Found: " + labelName +
